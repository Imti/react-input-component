...
var b = browserify(path.resolve('./src/index.jsx'), watchify.args);
var w = watchify(b);
...
server.listen(1111, function() {console.log(chalk.grey('serving ') + chalk.blue(path.resolve('./public/')) + chalk.grey(' on port ') + chalk.blue('1111'));});
